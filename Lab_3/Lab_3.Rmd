...
Answer: The shortest streak is of length 1 is false, the shortest is zero. 
...
Answer: In my simulation: 19 came up heads.
...
Answer: The most common streak is zero, and the max is four. 
...
Answer: Somewhat similar. It won't be exactly the same since it is simulated with only 133 shots. If we had 1000 shots then they would be near the same. 
...
Answer: The distributions look very similar. Option 1. There is no evidence. 
...
Answer: Concepts covered included independence vs dependence, histograms, fair and unfair (weighted) experiments, hypothesis testing. 
