...
ggplot(data = arbuthnot, aes(x = year, y = prop)) +
  geom_line() +
  geom_point()
```

Answer: I see that there are always more boys born than girls, with a peak difference around 1660. 
...
Answer: There are 3 variables in this dataset. 
...
Answer: The years included are from 1940 to 2013. 
...
Answer: Yes the proportion of boys has decreased over time. True
...
Answer: Every year had more boys than girls. 
...
Answer: The correct answer choice is the first one. The ration stays near constant, ranges within 0.01. 
