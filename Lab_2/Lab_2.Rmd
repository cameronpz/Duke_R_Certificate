...
Answer: There are 68 observations, thus there are 68 flights. 
...
sfo_feb_flights %>%
  summarise(mean_ad = mean(arr_delay), sd_ad = sd(arr_delay), median_ad = median(arr_delay), 
  var_ad = var(arr_delay), IQR_ad = IQR(arr_delay), n = n())
```

Answer: As there are observations at the 200 minute mark, flights were delayed by more than 2 hours. 
...
Answer: Both Delta and United Airlines are tied with 22
...
Answer: as seen from the summary table, July has the highest at 20.8
...
Answer: December has the highest at 1. 
...
Answer: the 3rd option as the delay is skewed. Median is a robust statistic, mean is not. The large delays skew the mean to the right. 
...
Answer: Based on the summary table, LGA has the best rate at 72.8%
...
Answer: N666DN has the highest avg speed. 
